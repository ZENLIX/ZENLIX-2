...
$.post(
        ACTIONPATH_PORTAL,
        { mode:"sort_units_manual_qa" ,list: list},
        function(data){
            console.log(data);
        }
    );
...
$.post(
        ACTIONPATH_PORTAL,
        { mode:"sort_units_manual" ,list: list},
        function(data){
            console.log(data);
        }
    );
...
$("#text_review").keyup(function (e) {
    if (e.keyCode == 13) {
        ...
        $('body').on('click', 'button#make_new_post_problem', function(event) {
            event.preventDefault(); $("#new_post_page").val('2');
...
$.post( ACTIONPATH_PORTAL, { mode: "change_manual_cat_main", hash: hash, name: name } );
...
$.post( ACTIONPATH_PORTAL, { mode: "change_manual_cat_type", hash: hash, name: name } );
...
$.post( ACTIONPATH_PORTAL, { mode: "change_todo_success", hash: hash, name: name } );
...
$.ajax({
                type: "POST",
                url: ACTIONPATH_PORTAL,
                data: {mode: 'del_version', news_hash: p},
                success: function(html) {
                    //console.log(html);
...
$.ajax({
                type: "POST",
                url: ACTIONPATH_PORTAL,
                data: {mode: 'del_news', news_hash: p},
                success: function(html) {
                    //console.log(html);
...
$.ajax({
                type: "POST",
                url: ACTIONPATH_PORTAL,
                data: {mode: 'get_orig_post', post_hash: v, type: type},
                success: function(html) {
                    //console.log(html);
                    //window.location = MyHOSTNAME + "thread?"+v;
                    $("#"+v+" .editable_text").html(html);
...
$.ajax({
                type: "POST",
                url: ACTIONPATH_PORTAL,
                data: {mode: 'get_orig_comment', post_hash: v, type: type},
                success: function(html) {
                    //console.log(html);
                    //window.location = MyHOSTNAME + "thread?"+v;
                    $("#"+v+" .editable_text").html(html);
...
$.ajax({
                type: "POST",
                url: ACTIONPATH_PORTAL,
                data: {mode: 'update_post', post_hash: v, msg: m, type:type},
                success: function(html) {
                    //console.log(html);
                    //window.location = MyHOSTNAME + "thread?"+v;
                    $("#"+v+" .editable_text").html(html);
...
$.ajax({
                type: "POST",
                url: ACTIONPATH_PORTAL,
                data: {mode: 'update_comment', post_hash: v, msg: m, type:type},
                success: function(html) {
                    //console.log(html);
                    //window.location = MyHOSTNAME + "thread?"+v;
                    $("#"+v+" .editable_text").html(html);
