...
'mail_msg_ticket_lock_ext'=>'Вы получили это сообщение, потому что заявка была взята в обработку пользователем',
'mail_msg_ticket_unlock'=>'ЗАЯВКА РАЗБЛОКИРОВАНА',
'mail_msg_ticket_unlock_ext'=>'Вы получили это сообщение, потому что заявка была взята в обработку пользователем',
...
'NEWS_action_lock'=>'взял в обработку заявку',
...
'CONF_file_size'=>'Максимальный размер файла',    
 ...
 'DASHBOARD_ticket_lock'=>'взято в обработку мной',
...
'TICKET_msg_lock'=>'Заявка взята в обработку',
