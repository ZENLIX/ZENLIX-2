...
$url = parse_url($CONF['hostname']);
	...
	case 'view_user': 	include('inc/view_user.php');	break;
	...
	case 'user_stats':	include('inc/user_stats.php');	break;
	case 'messages':	include('inc/messages.php');	break;
...
$url = parse_url($CONF['hostname']);
    ...
    if (!isset($_GET['page'])) {        
    	...
    	include("inc/head.inc.php");
        include("inc/client.navbar.inc.php");//client
        include("inc/client.dashboard.php"); //client
		include("inc/footer.inc.php");
		}
		...
		switch($_GET['page']) {
	case 'create': 	include('inc/client.new.php');		break;
	case 'list': 	include('inc/client.list.php');	break;
	case 'ticket': 	include('inc/client.ticket.php');	break;
	case 'helper': 	include('inc/client.helper.php');	break;
	case 'profile': include('inc/client.profile.php');	break;
	default: include('404.php');
}	
		}
