...
<div class="row">
	...
	<div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <strong ><small><?=lang('PROFILE_priv');?>:</small></strong><br>
									<small><?=priv_status_name($usid);?></small>
                                    <hr>
                                    <strong><small><?=lang('PROFILE_priv_unit');?>:</small></strong>
                                    <p><small><?=view_array(get_unit_name_return(unit_of_user($_SESSION['helpdesk_user_id'])));?></small></p>
                                                                    </div><!-- /.box-body -->
...
<div class="col-md-12">
    ...
    <label for="fio" class="col-sm-4 control-label"><small><?=lang('WORKER_fio');?></small></label>
        <div class="col-sm-8">
    <input autocomplete="off" name="fio" type="text" class="form-control input-sm" id="fio" placeholder="<?=lang('WORKER_fio');?>" value="<?=$fio;?>">
        </div>
  </div>
  
  
    <div class="form-group">
    <label for="mail" class="col-sm-4 control-label"><small><?=lang('P_mail');?></small></label>
        <div class="col-sm-8">
    ...
    <p class="help-block"><small><?=lang('P_mail_desc');?></small></p>
      ...
      <div class="form-group">
    <label for="tel" class="col-sm-4 control-label"><small><?=lang('WORKER_tel_full');?></small></label>
        <div class="col-sm-8">
    ...
    <input autocomplete="off" name="skype" type="text" class="form-control input-sm" id="skype" placeholder="skype" value="<?=$skype;?>">
          ...
          <div class="form-group">
    <label for="adr" class="col-sm-4 control-label"><small><?=lang('APPROVE_adr');?></small></label>
        <div class="col-sm-8">
    ...
    <div class="controls">
        <div class="form-group">
            <label for="posada" class="col-sm-4 control-label"><small><?=lang('WORKER_posada');?>: </small></label>
 ...
 <div class="control-group">
    <div class="controls">
        <div class="form-group">
            <label for="pidrozdil" class="col-sm-4 control-label"><small><?=lang('WORKER_unit');?>: </small></label>
            <div class="col-sm-8" style="">
        ...
        foreach($res1 as $row) {
          ...
          <div class="form-group">
    <label for="lang" class="col-sm-4 control-label"><small><?=lang('SYSTEM_lang');?></small></label>
        <div class="col-sm-8">
...
<div class="col-md-12">
	<?php
      ...
      <form class="form-horizontal" role="form">
              ...
              <div class="form-group">
    <label for="old_pass" class="col-sm-4 control-label"><small><?=lang('P_pass_old');?></small></label>
        <div class="col-sm-8">
    <input autocomplete="off" name="old_pass" type="password" class="form-control input-sm" id="old_pass" placeholder="<?=lang('P_pass_old2');?>">
        ...
        <div class="form-group">
    <label for="new_pass" class="col-sm-4 control-label"><small><?=lang('P_pass_new');?></small></label>
        <div class="col-sm-8">
    <input autocomplete="off" name="new_pass" type="password" class="form-control input-sm" id="new_pass" placeholder="<?=lang('P_pass_new2');?>">
          ...
          <div class="form-group">
    <label for="new_pass2" class="col-sm-4 control-label"><small><?=lang('P_pass_new_re');?></small></label>
        <div class="col-sm-8">
