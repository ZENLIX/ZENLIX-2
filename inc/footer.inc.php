...
<script type="text/javascript">
    ...
    var USER_HASH = "<?=get_user_val('uniq_id');?>";
    var NODE_PORT = "<?=get_conf_param('node_port');?>";
</script>
...
<?php if ( get_current_URL_name('create')) {?>
<script src="<?=$CONF['hostname']?>js/jquery.ui.autocomplete.js"></script>
<?php } ?>

<?php if ( (get_current_URL_name('create')) || get_current_URL_name('deps') ) {?>
<script src="<?=$CONF['hostname']?>js/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
<?php } ?>

<?php if ( (get_current_URL_name('list')) || get_current_URL_name('users') ) {?>
<script src="<?=$CONF['hostname']?>js/bootstrap-paginator.js"></script>
<script src="<?=$CONF['hostname']?>js/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
<?php } ?>

<?php if (get_current_URL_name('clients')) { ?>
<script src="<?=$CONF['hostname']?>js/bootstrap-paginator.js"></script>
<?php } ?>



<?php if (get_current_URL_name('ticket') ) {?>
<script src="<?=$CONF['hostname']?>js/s2/select2.min.js"></script>
<script src="<?=$CONF['hostname']?>js/jquery.autosize.min.js"></script>
<script src="<?=$CONF['hostname']?>js/bootstrap.file-input.js"></script>

<?php } ?>

<?php if ( (get_current_URL_name('create')) ||  get_current_URL_name('users') ) {?>
<script src="<?=$CONF['hostname']?>js/s2/select2.min.js"></script>
<script src="<?=$CONF['hostname']?>js/jquery.autosize.min.js"></script>
...
<?php if ( (get_current_URL_name('helper')) || get_current_URL_name('notes') ) {?>
<script src="<?=$CONF['hostname']?>js/summernote.min.js"></script>
<script src="<?=$CONF['hostname']?>js/summernote-lang.js"></script>
<?php } ?>

<?php if ( get_current_URL_name('stats') ) {?>
<script src="<?=$CONF['hostname']?>js/highcharts.js"></script>
<?php } ?>


<?php if ( get_current_URL_name('view_user') ) {?>
<script src="<?=$CONF['hostname']?>js/jqueryKnob/jquery.knob.js"></script>
<?php } ?>

<?php if ( get_current_URL_name('user_stats') ) {?>
<script src="<?=$CONF['hostname']?>js/daterangepicker.js?v5"></script>
<script src="<?=$CONF['hostname']?>js/s2/select2.min.js"></script>
<script src="<?=$CONF['hostname']?>js/jqueryKnob/jquery.knob.js"></script>
<?php } ?>
...
<script src="<?=$CONF['hostname']?>js/socket.io-1.1.0.js"></script>
