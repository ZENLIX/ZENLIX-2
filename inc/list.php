...
<section class="content-header">
                    <h1>
                        <i class="fa fa-list-alt"></i> <?= lang('LIST_title'); ?>
                        <small>
                        	
                        	<?php if ($priv_val != "2") { ?>
								<span data-toggle="tooltip" data-placement="right" data-html="true" title="<?=view_array($text); ?>"><?=lang('LIST_pin')?>: <?=count($text); ?>
								</span>
								<?php }
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><span class="icon-svg"></span> <?=$CONF['name_of_firm']?></a></li>
                        <li class="active"><?= lang('LIST_title'); ?></li>
                    </ol>
                </section>
...
<div class="col-md-12">
    ...
    <div class="box box-solid">
                        ...
                        <div class="input-group">
                            ...
                            <input name="t" type="text" class="form-control input-sm pull-right" id="input_find" data-toggle="tooltip" data-placement="bottom" title="<?= lang('LIST_find_ph'); ?>" style="width: 250px;">
                              <input name="find" type="hidden">
      <div class="input-group-btn">
        <button class="btn btn-sm btn-info btn-flat" type="submit" title="<?=lang('EXT_press_tofind');?>" id=""><i class="fa fa-search"></i> <?= lang('LIST_find_button'); ?></button>
