...
?>
            ...
            <input type="hidden" id="total_pages" value="<?php echo get_total_pages('clients', $_SESSION['helpdesk_user_id']); ?>">
            <input type="hidden" id="last_ticket" value="<?= get_last_ticket('client', $_SESSION['helpdesk_user_id']); ?>">
