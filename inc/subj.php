...
<section class="content-header">
        ...
        <button id="subj_add" class="btn btn-default btn-sm btn-block" type="submit"><?=lang('SUBJ_add');?></button>
      <br>
