...
?>
                <section class="content-header">
                    <h1>
                        <i class="fa fa-bullhorn"></i> <?php echo lang('NAVBAR_news'); ?>
                        <small><?php echo lang('DASHBOARD_last_news'); ?></small>
                    </h1>
                    <ol class="breadcrumb">
                       <li><a href="<?php echo $CONF['hostname'] ?>index.php"><span class="icon-svg"></span> <?php echo $CONF['name_of_firm'] ?></a></li>
                        <li class="active"><?php echo lang('NAVBAR_news'); ?></li>
                    </ol>
                </section>
...
?>
                    <li>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <time id="c" datetime="<?php echo $t_dc
?>"></time></small></span>
                                        <h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a> 
                                        <?php echo lang('NEWS_action_lock'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a></h3>
<div class="timeline-body">

<small class="" style="margin-top: 0px; margin-bottom: 0px;">
                                <?php echo make_html(get_ticket_val_by_hash('msg', get_ticket_hash_by_id($t_id)), 'no'); ?>...
                            </small>
...
?>
                    <li>
                                    ...
                                    <div class="timeline-item">
                                        <span class="time"><small><i class="fa fa-clock-o"></i> <time id="c" datetime="<?php echo $t_dc
?>"></time></small></span>
                                        <h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a>
                                        
                                        
                                         <?php echo lang('NEWS_action_unlock'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a></h3>
<div class="timeline-body">
...
<div class="timeline-footer">
                                            <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>" class="btn btn-xs bg-maroon"><?php echo lang('EXT_news_view_t'); ?></a>
                                        </div>
                                    </div>
                                </li>
...
?>"></time></small></span>
                                        <h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a>
                                         ...
                                         <?php echo lang('NEWS_action_ok'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a></h3>
...
?>"></time></small></span>
                                        <h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a>
                                         ...
                                         <?php echo lang('NEWS_action_no_ok'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a>, <?php echo lang('NEWS_action_no_ok2'); ?></h3>
                                         <div class="timeline-body">
...
<small class="" style="margin-top: 0px; margin-bottom: 0px;">
                                <?php echo make_html(get_ticket_val_by_hash('msg', get_ticket_hash_by_id($t_id)), 'no'); ?>...
                                         ...
                                         <div class="timeline-footer">
                                            <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>" class="btn btn-xs bg-red"><?php echo lang('EXT_news_view_t'); ?></a>
                                        </div>
...
?>"></time></small></span>
                                        <h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a>
                                         ...
                                         <?php echo lang('NEWS_action_refer'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a>  <?php echo lang('mail_msg_ticket_to_ext'); ?> <?php echo $to_text; ?> </h3>
                                        <div class="timeline-body">
...
<h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a>
                                         ...
                                         <?php echo lang('NEWS_action_comment'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a></h3>
                                         <div class="timeline-body">
...
<small >
                                <?php echo make_html(get_ticket_val_by_hash('msg', get_ticket_hash_by_id($t_id)), 'no'); ?>...
                                        ...
                                        <small class="text-muted"><em><?php echo lang('NEWS_text_comment'); ?>:</em></small>
                                        <small><p>
                                            <?php
...
?>
                                        ...
                                        <div class="timeline-footer">
                                            <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>" class="btn btn-xs bg-purple"><?php echo lang('EXT_news_view_t'); ?></a>
                                        </div>
                                    </div>
                                </li>
...
?>"></time></small>
                                        ...
                                        <h3 class="timeline-header no-border"><a href="view_user?<?php echo get_user_hash_by_id($init_user); ?>"><?php echo name_of_user_ret($init_user) ?></a>
                                         ...
                                         <?php echo lang('NEWS_action_create'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a></h3>
                                        <div class="timeline-body">
...
<div class="timeline-footer">
                                            <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>" class="btn btn-xs bg-aqua"><?php echo lang('EXT_news_view_t'); ?></a>
                                        </div>
                                    </div>
                                </li>
...
?>"></time></small>
                                        ...
                                        <h3 class="timeline-header no-border">
                                         ...
                                         <?php echo lang('FILES_ticket'); ?> <a href="ticket?<?php echo get_ticket_hash_by_id($t_id) ?>">#<?php echo $t_id; ?></a> <?php echo lang('NEWS_action_ticket_arch'); ?></h3>
                                        <div class="timeline-body">
