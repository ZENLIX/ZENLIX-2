...
<link rel="stylesheet" href="<?=$CONF['hostname']?>/css/ionicons.min.css">
...
<?php if ( (get_current_URL_name('create')) || get_current_URL_name('ticket') || get_current_URL_name('users') || get_current_URL_name('user_stats')) {?>
...
<link rel="stylesheet" href="<?=$CONF['hostname']?>/css/daterangepicker-bs3.css">
<?php } ?>


<link rel="stylesheet"type="text/css" media="print" href="<?=$CONF['hostname']?>/css/print.css">
<link rel="stylesheet" href="<?=$CONF['hostname']?>/css/AdminLTE.css">
