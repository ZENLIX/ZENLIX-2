...
<div class="col-md-8">
	...
	<div class="col-md-12">
                ...
                <tr>
                    ...
                    <td><small><a href="view_user?<?=get_user_hash_by_id($row['user_init_id']);?>"><?=name_of_user($row['user_init_id'])?> </a></small></td>
			...
			<div class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                            ...
                            <button type="button" class="btn btn-default btn-xs pull-right" data-toggle="modal" data-target="#myModal"><?=lang('CONF_act_edit');?></button>
                            </div>
                            </div>                            <?php }
                                ...
                                <div class="box-footer">
                                    <div class="input-group" id="for_msg">
                                        ...
                                        <div class="input-group-btn">
                                            <button value="<?=$hn?>" id="do_comment" class="btn btn-success"><i class="fa fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
