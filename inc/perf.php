...
<section class="content-header">
                    <h1>
                        <i class="fa fa-cog"></i>  <?=lang('CONF_title');?>
                        <small><?=lang('CONF_title_ext');?></small>
                    </h1>
                    <ol class="breadcrumb">
                       <li><a href="<?=$CONF['hostname']?>index.php"><span class="icon-svg"></span> <?=$CONF['name_of_firm']?></a></li>
                        <li class="active"><?=lang('CONF_title');?></li>
                    </ol>
                </section>
...
<div class="box box-solid bg-maroon">
                                <div class="box-header">
                                    <h3 class="box-title">ZENLIX v.<?=get_conf_param('version');?></h3>
                                </div>
                                <div class="box-body">
...
<div class="box-header">
<h3 class="box-title"><i class="fa fa-cog"></i> <?=lang('CONF_mains');?></h3>
</div>
			<div class="box-body">
  ...
  <div class="form-group">
    <label for="ldap_ip" class="col-sm-4 control-label"><small><?=lang('EXT_ldap_ip');?></small></label>
    <div class="col-sm-8">
      <input type="text" class="form-control input-sm" id="ldap_ip" placeholder="<?=lang('EXT_ldap_ip');?>" value="<?=get_conf_param('ldap_ip')?>">
    </div>
  </div>
    <div class="form-group">
    <label for="ldap_domain" class="col-sm-4 control-label"><small><?=lang('EXT_ldap_domain');?></small></label>
    <div class="col-sm-8">
      <input type="text" class="form-control input-sm" id="ldap_domain" placeholder="<?=lang('EXT_ldap_domain');?>" value="<?=get_conf_param('ldap_domain')?>">
    </div>
  </div>
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control input-sm" id="node_port" placeholder="8080" value="<?=get_conf_param('node_port')?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <span class="input-group-addon"><small><?=site_proto();?></small></span>
...
<div class="form-group">
    <label for="time_zone" class="col-sm-4 control-label"><small><?=lang('CONF_timezone');?></small></label>
    <div class="col-sm-8">
...
<select class="form-control input-sm" id="time_zone">
  <?php foreach ($timezones as $key => $value) {
    ?>
    <option value="<?=$key;?>" <?php if (get_conf_param('time_zone') == $key) {echo "selected";} ?> ><?=$value;?></option>
    <?php
  } ?>
...
<pre>5 0 * * * /usr/bin/php5 -f <?=realpath(dirname(dirname(__FILE__)))."/sys/4cron.php"?> > <?=realpath(dirname(dirname(__FILE__)))."/4cron.log"?> 2>&1</pre></small></p>
    </div>
  </div>
...
<div class="box box-solid">
<div class="box-header">
<h3 class="box-title"><i class="fa fa-bell"></i> <?=lang('CONF_mail_name');?></h3>
</div>
			<div class="box-body">
			<form class="form-horizontal" role="form">
...
</select>   <p class="help-block"><small><?=lang('CONF_2noty_info');?> <br>
      <pre>* * * * * /usr/bin/php5 -f <?=realpath(dirname(dirname(__FILE__)))."/sys/4cron_notify.php"?> > <?=realpath(dirname(dirname(__FILE__)))."/4cron.log"?> 2>&1</pre></small></p> </div>
  </div>
...
<div class="col-md-12">
	<div class="box box-solid">
<div class="box-header">
<h3 class="box-title"><i class="fa fa-bell"></i> <?=lang('EXT_pb_noti');?></h3>
</div>
			<div class="box-body">
			<form class="form-horizontal" role="form">
  ...
  <div class="form-group">
    <label for="from" class="col-sm-4 control-label"><small><?=lang('EXT_pb_api_key');?></small></label>
    <div class="col-sm-8">
      <input type="text" class="form-control input-sm" id="pb_api" placeholder="<?=lang('EXT_pb_api_key');?>" value="<?=get_conf_param('pb_api')?>">
    </div>
  </div>
<div class="">
<center>
    <button type="submit" id="conf_edit_pb" class="btn btn-success"><i class="fa fa-pencil"></i> <?=lang('CONF_act_edit');?></button>
