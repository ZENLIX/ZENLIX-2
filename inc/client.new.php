...
<div class="col-md-10" id="processing">
    <div class="btn-group btn-group-justified">
        <div class="btn-group">
            <button id="enter_ticket_client" class="btn btn-success" type="button"><i class="fa fa-check-circle-o"></i> <?=lang('NEW_button_create');?></button>
        </div>
        <div class="btn-group">
    ...
    <input type="hidden" id="client_id_param" value="<?php echo $_SESSION['helpdesk_user_id']; ?>">
