...
<section class="content-header">
                    <h1>
                        <i class="fa fa-male"></i> <?php echo lang('POSADA_title'); ?>
                        <small><?php echo lang('POSADA_title_ext'); ?></small>
                    </h1>
                    <ol class="breadcrumb">
                       <li><a href="<?php echo $CONF['hostname'] ?>index.php"><span class="icon-svg"></span> <?php echo $CONF['name_of_firm'] ?></a></li>
                        <li class="active"><?php echo lang('POSADA_title'); ?></li>
                    </ol>
                </section>
...
<table class="table table-bordered table-hover" style=" font-size: 14px; " id="">
        <thead>
          <tr>
            ...
            <th><center><?php echo lang('POSADA_n'); ?></center></th>
            <th><center><?php echo lang('POSADA_action'); ?></center></th>
          </tr>
        </thead>
    <tbody>   
    <?php
