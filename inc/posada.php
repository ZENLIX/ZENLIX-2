...
<section class="content-header">
                    <h1>
                        <i class="fa fa-male"></i> <?=lang('POSADA_title');?>
                        <small><?=lang('POSADA_title_ext');?></small>
                    </h1>
                    <ol class="breadcrumb">
                       <li><a href="<?=$CONF['hostname']?>index.php"><span class="icon-svg"></span> <?=$CONF['name_of_firm']?></a></li>
                        <li class="active"><?=lang('POSADA_title');?></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="row">
                    <div class="col-md-3">
                    <input type="text" class="form-control input-sm ui-autocomplete-input" id="posada_text" placeholder="<?=lang('POSADA_name');?>" autocomplete="off"><button id="posada_add" class="btn btn-default btn-sm btn-block" type="submit"><?=lang('POSADA_add');?></button><br>
