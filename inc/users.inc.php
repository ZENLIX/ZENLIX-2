...
<form class="form-horizontal" role="form">
  ...
  <div class="col-sm-10">
	  ...
	  <div class="checkbox">
    <label>
      <input type="checkbox" id="ldap_auth_key"> <?=lang('CONF_true');?>
      <p class="help-block"><small><?=lang('EXT_perf_must_ldap');?> </small></p>
    </label>
  </div>
	  </div>
  </div>
    ...
    <div class="form-group">
    <label for="tel" class="col-sm-2 control-label"><?=lang('APPROVE_tel');?></label>
        <div class="col-sm-10">
    <input autocomplete="off" name="tel" type="text" class="form-control input-sm" id="tel" placeholder="<?=lang('APPROVE_tel');?>">
        </div>
  </div>
    ...
    <input autocomplete="off" name="skype" type="text" class="form-control input-sm" id="skype" placeholder="skype">
      ...
      <div class="form-group">
    <label for="adr" class="col-sm-2 control-label"><?=lang('APPROVE_adr');?></label>
        <div class="col-sm-10">
   ...
   <div class="control-group">
    <div class="controls">
        <div class="form-group">
            <label for="posada" class="col-sm-2 control-label"><?=lang('WORKER_posada');?>: </label>
 ...
 <div class="control-group">
    <div class="controls">
        <div class="form-group">
            <label for="pidrozdil" class="col-sm-2 control-label"><?=lang('WORKER_unit');?>: </label>
            <div class="col-sm-10" style="">
...
<div class="radio col-sm-12">
  <label>
    ...
    <strong class="text-default"><?=lang('EXT_client');?></strong>
    <p class="help-block"><small><?=lang('EXT_client_what');?></small></p>
  </label>
...
//echo($row['label']);
  ...
  <div class="form-group">
    <label for="msg_title" class="col-sm-2 control-label"><?=lang('EXT_perf_msg_t');?></label>
        <div class="col-sm-10">
    <input autocomplete="off" name="msg_title" type="text" class="form-control input-sm" id="msg_title" placeholder="<?=lang('EXT_perf_msg_t');?>">
        </div>
  </div>
  ...
  <table class="table table-hover table-bordered">
    ...
    $t=($_POST['t']);
	    ...
	    //$results = mysql_query("SELECT id, fio, login, tel, unit_desc, adr, email, posada from clients where ((fio like '%" . $t . "%') or (login like '%" . $t . "%')) limit $start_pos, $perpage;");
	        ...
	        $stmt = $dbConnection->prepare('SELECT id, fio, login, tel, unit, adr, email, posada, uniq_id, is_client,status from users where ((fio like :t) or (login like :t2)) limit :start_pos, :perpage');
	...
	?>
          <tr class="">
            ...
            <td><small><a href="<?php echo $CONF['hostname']; ?>users?edit=<?=$row['uniq_id'];?>"><?php echo $row['fio']; ?></a></small></td>
            ...
            <td><small><center><button id="make_logout_user" value="<?=$row['uniq_id'];?>" class="btn btn-warning btn-xs">logout</button></center></small></td>
          </tr>
          <?php } ?>
       </tbody>
      </table>
...
<div class="box-header">
  ...
  <div class="form-group" id="pass_user_grp">
    <label for="exampleInputPassword1" class="col-sm-2 control-label"><?=lang('USERS_pass');?></label>
        <div class="col-sm-10">
    <input autocomplete="off" name="password" type="password" class="form-control input-sm" id="exampleInputPassword1" placeholder="<?=lang('USERS_pass');?>" <?=$pd?>>
        </div>
  </div>
  <div class="form-group">
  <label for="ldap_auth_key" class="col-sm-2 control-label">LDAP-auth</label>
  <div class="col-sm-10">
	  ...
	  <div class="checkbox">
    <label>
      <input type="checkbox" id="ldap_auth_key" <?=$lk_status;?>> <?=lang('CONF_true');?>
      <p class="help-block"><small><?=lang('EXT_perf_must_ldap');?> </small></p>
    </label>
  </div>
	  </div>
    ...
    <label for="push" class="col-sm-2 control-label">Push</label>
        <div class="col-sm-10">
    <input autocomplete="off" name="push" type="text" class="form-control input-sm" id="push" placeholder="push" value="<?=$push;?>">
        </div>
  </div>
    ...
    <label for="tel" class="col-sm-2 control-label"><?=lang('APPROVE_tel');?></label>
        <div class="col-sm-10">
    <input autocomplete="off" name="tel" type="text" class="form-control input-sm" id="tel" placeholder="<?=lang('APPROVE_tel');?>" value="<?=$tel;?>">
        </div>
  </div>
...
<div class="radio col-sm-12">
  <label>
    <input type="radio" name="optionsRadios" id="optionsRadios4" value="4" <?=$status_client?>>
    <strong class="text-default"><?=lang('EXT_client');?></strong>
    <p class="help-block"><small><?=lang('EXT_client_what');?></small></p>
  </label>
...
//
  ...
  <div class="col-sm-10">
    ...
    <select data-placeholder="<?=lang('SYSTEM_lang');?>" class="chosen-select form-control input-sm" id="lang" name="lang">
                    <option value="0"></option>
                        ...
                        <option value="en" <?=$status_lang_en;?>>English</option>
                        <option value="ru" <?=$status_lang_ru;?>>Русский</option>
                        <option value="ua" <?=$status_lang_ua;?>>Українська</option>
</select>
        </div>
  </div>
  ...
  <div class="form-group">
    <label for="msg_title" class="col-sm-2 control-label"><?=lang('EXT_perf_msg_t');?></label>
        <div class="col-sm-10">
    <input autocomplete="off" name="msg_title" type="text" class="form-control input-sm" id="msg_title" placeholder="<?=lang('EXT_perf_msg_t');?>" value="<?=$msg_t;?>">
        </div>
  </div>
...
<div class="">
<center>
    <button type="submit" id="edit_user" value="<?=$usid;?>" class="btn btn-success"><?=lang('USERS_make_edit_user');?></button>
</center>
</div>
</form>
