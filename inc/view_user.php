                            ...
                            <div class="panel-body">
                                <section class="content">
                                    <div class="error-page">
                                        ...
                                        <div class="">
                                            <h3><i class="fa fa-warning text-red"></i> <?php echo lang('USER_DEL_main'); ?></h3>
                                            <p>
                                            <?php echo lang('USER_DEL_info'); ?>
                                            </p>
            ...
            <div class="col-md-3">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        echo $user_last_time ?>"></time></small>
                        </center>
                        <?php
                                }
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3"><small class="text-muted"><?php echo lang('APPROVE_adr'); ?>:</small></div>
                                                    ...
                                                    <?php
                                                    if ($user_tel) { ?><div class="col-md-3"><small class="text-muted"><?php echo lang('APPROVE_tel'); ?>:</small></div>
                                                    <div class="col-md-9"><small><?php
                                                    ...
                                                    <?php
                                                    if ($user_mail) { ?>
                                                    <div class="col-md-3"><small class="text-muted"><?php echo lang('APPROVE_mail'); ?>:</small></div>
                                                    <div class="col-md-9"><small><?php
                                                    ...
                                                    <br><br><br>
                                                    <center>
                                                    <?php echo lang('FIELD_add_title'); ?></center>
                                                    <table class="table  ">
                                                        <tbody>
                                                            <?php
