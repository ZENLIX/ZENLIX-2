...
?>
                ...
                <section class="content-header">
                    <h1>
                        <i class="fa fa-tag"></i> <?=lang('NEW_title');?>
                        
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?=$CONF['hostname']?>"><span class="icon-svg"></span>  <?=$CONF['name_of_firm']?></a></li>
                        <li class="active"><?=lang('NEW_title');?></li>
                    </ol>
                </section>
...
<div class="control-group">
    <div class="controls">
        <div class="form-group" id="for_fio">
            ...
            <div class="col-sm-10"data-toggle="tooltip" data-placement="right" title="<?=lang('NEW_from_desc');?>">
                ...
                <a id="select_init_user" param-hash="<?=get_user_val('uniq_id');?>" href='#' class="input-group-addon">Я</a>
				</div>
    ...
    <hr>
<div data-toggle="tooltip" data-placement="right" title="<?=lang('NEW_to_desc');?>">
...
//echo($row['label']);
    ...
    <select data-placeholder="<?=lang('NEW_to_user');?>" id="users_do" name="unit_id" class="form-control input-sm" multiple>
    	<option></option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10" style=" padding-top: 5px; ">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="<?=lang('NEW_prio_high_desc');?>" id="prio_high"><i id="lprio_high" class=""></i><?=lang('NEW_prio_high');?></button>
                    </div>
                </div>
            </div></div></div></div>
<?php
...
<div class="control-group " >
    <div class="controls">
        <div class="form-group " id="for_subj" data-toggle="popover" data-html="true" data-trigger="manual" data-placement="right" data-content="<small><?=lang('NEW_subj_msg');?></small>">
            <label for="subj" class="col-sm-2 control-label"><small><?=lang('NEW_subj');?>: </small></label>
            <div class="col-sm-10 " style="">
                <select data-placeholder="<?=lang('NEW_subj_det');?>" class="chosen-select form-control input-sm " id="subj" name="subj" multiple>
                    <option value="0"></option>
                    <?php
...
<div class="col-md-10" id="processing">
    ...
    <input type="hidden" id="user_name_login" value="<?=get_user_val('login');?>">
