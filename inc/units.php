...
<section class="content-header">
        ...
        <button id="units_add" class="btn btn-default btn-sm btn-block" type="submit"><?=lang('UNITS_add');?></button>
      <br>
