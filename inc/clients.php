...
<section class="content-header">
                    <h1>
                        <i class="fa fa-users"></i> <?=lang('USERS_list');?>
                        <small><?=lang('UNITS_title_ext');?></small>
                    </h1>
                    <ol class="breadcrumb">
                       <li><a href="<?=$CONF['hostname']?>index.php"><span class="icon-svg"></span> <?=$CONF['name_of_firm']?></a></li>
                        <li class="active"><?=lang('USERS_list');?></li>
                    </ol>
                </section>
...
<div class="col-md-12">
	...
	<div class="box-body">
	<?php if (get_user_val('priv_add_client') == "1") { ?>
	<a href="?add" class="btn btn-success btn-block"><i class="fa fa-male"></i> <?=lang('USERS_create');?></a>
	<?php } ?>
	<a href="?list" class="btn btn-primary btn-block"><i class="fa fa-list-alt"></i> <?=lang('USERS_list');?></a>
